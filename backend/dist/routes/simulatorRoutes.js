...
import { forceSimulatorOutsideFence, getSimulatorState, resetSimulatorPosition, setSimulatorInterval, setSimulatorMode, tickSimulator } from "../services/simulatorService.js";
export function createSimulatorRoutes(broadcast, refreshLoop) {
    const router = Router();
